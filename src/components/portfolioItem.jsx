...
function PortfolioItem ({title, imgUrl, stack, link}) {
    ...
    return (
        <div className="border-2 border-stone-900 rounded-md ovweflow-hidden">    
            <img 
                src={imgUrl}
                alt="portfolio"
            ...
            <div className="w-full p-4">
                ...
                <p className="flex flew-wrap gap-2 flex-row items-center justify-start text-xs md:text-sm">
                    {stack.map(item => (
